...
# 🎮 DIG Raiders: Anomaly Extraction — Community Edition

**Co-op underground extraction: dig, raid, and survive in a self-contained build.**
...
DIG Raiders: Anomaly Extraction is a co-op first-person extraction game set in procedurally generated underground complexes. Squads dig through destructible terrain, secure volatile anomalies, and haul payloads to the extraction elevator under escalating pressure. This Community Edition is a standalone build of the full game, including all content and expansions in a self-contained package. It runs offline with no storefront required and is ready to play immediately.

Players who want a complete, self-contained version of DIG Raiders: Anomaly Extraction playable offline on Windows PCs.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4368640/dabefdc7bf76346e9598c30cb4b0bc6a6e2834a4/ss_dabefdc7bf76346e9598c30cb4b0bc6a6e2834a4.1920x1080.jpg?t=1789554856" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4368640/19eccd969007723c71add7d94fac3b87ad8022eb/ss_19eccd969007723c71add7d94fac3b87ad8022eb.1920x1080.jpg?t=1789554856" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4368640/259c8d91ccba55d0254b1293879162c49463d7e7/ss_259c8d91ccba55d0254b1293879162c49463d7e7.1920x1080.jpg?t=1789554856" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- ✅ **Multiplayer support** — LAN and direct P2P connection supported; up to 4 players
...
| **Multiplayer** | LAN and direct P2P connection supported; up to 4 players |
...
- ⛏️ **Procedural Excavation** — Destructible terrain with procedurally generated tunnel networks in every raid.
- 👥 **Four-Player Co-op** — Squad-based raids via LAN or direct connection, no storefront required.
- 🧿 **Anomaly Extraction Loop** — Locate volatile anomalies, secure payloads, and reach the extraction elevator.
- 🛠️ **Gear and Crafting** — Upgrade drills, exosuits, and gadgets with salvaged underground materials.
- 🌋 **Hostile Biomes** — Six underground regions with unique hazards, fauna, and mission objectives.
- 📦 **Complete Content** — Includes all content from the base game and released expansions.
- 📴 **Offline Version** — Single-player and offline modes run without any account or storefront.
- 🖥️ **Self-Contained Package** — No additional software required; install and play on Windows 10/11.

- **Compression:** Lossless
- **Install Time:** ~12 minutes on SSD, ~35 minutes on HDD
- **Recoding:** none
...
- Deep Cache Expansion
- Raider Supply Pack
- Anomaly Hunter Cosmetic Set
...
| **Processor** | Intel Core i5-8400 / AMD Ryzen 5 2600 | Intel Core i7-10700K / AMD Ryzen 7 3700X |
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 1060 6 GB / AMD Radeon RX 580 | NVIDIA GeForce RTX 2070 / AMD Radeon RX 5700 XT |
| **Storage** | 30 GB available space | 30 GB on an SSD |
| **Additional** | DirectX 12 compatible system | SSD storage and DirectX 12 compatible system |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\DIGRaiders:AnomalyExtraction\Saved`
